...
public class Database {
    ...
    void createTables()
    {
        try
        {
          ...
          String URLTable= "CREATE TABLE SearchEngine.Websites " +
                          "(Link_ID BIGINT UNIQUE NOT NULL AUTO_INCREMENT, " +
                          " Link VARCHAR(255) UNIQUE, " + 
                          " Document LONGTEXT, " +
                          " PRIMARY KEY ( Link_ID ))"; 
            
           String AlterWebsites = "ALTER TABLE SearchEngine.Websites AUTO_INCREMENT = 1";

           PreparedStatement ps1 = conn.prepareStatement(URLTable);
           ps1.executeUpdate();
           
           PreparedStatement ps11 = conn.prepareStatement(AlterWebsites);
           ps11.executeUpdate();
           ...
           String KeywordsTable= "CREATE TABLE SearchEngine.Keywords " +
                         "(Keyword_ID BIGINT UNIQUE NOT NULL AUTO_INCREMENT, " +
           ...
           String InfoTable= "CREATE TABLE SearchEngine.Information " +
                         ...
                         " FOREIGN KEY (Link_ID) REFERENCES SearchEngine.Websites (Link_ID) ON DELETE CASCADE ON UPDATE CASCADE," +
                         " FOREIGN KEY (Keyword_ID) REFERENCES SearchEngine.Keywords (Keyword_ID) ON DELETE CASCADE ON UPDATE CASCADE," + 
                         " Importance CHAR, " +
                         " Frequency DOUBLE, " + 
   ...
   @SuppressWarnings("null")
    ...
    String SelectURL () throws SQLException, IOException
    {
